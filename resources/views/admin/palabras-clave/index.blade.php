        ...
        <div class="bg-white rounded-2xl card-shadow p-8 mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Configura el sistema de detección de síntomas y asignación automática
                    </p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl card-shadow p-6 text-center">
                <div class="text-3xl font-bold text-green-500">
                    {{ $palabrasClave->flatten()->where('estado', true)->count() }}</div>
                <div class="text-gray-600">Activas</div>
            </div>
            <div class="bg-white rounded-xl card-shadow p-6 text-center">
                <div class="text-3xl font-bold text-red-500">
                    {{ $palabrasClave->flatten()->where('nivel_alerta', 'critico')->count() }}</div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach ($palabras as $palabra)
                                <div
                                    class="border rounded-lg p-4 {{ $palabra->color_alerta }} transition duration-300 hover:shadow-md">
                                    <div class="flex justify-between items-start mb-2">
                                        ...
                                        <div class="flex space-x-1">
                                            ...
                                            <button onclick="cambiarEstado({{ $palabra->id_palabra_clave }})"
                                                ...
                                                <i
                                                    class="fas {{ $palabra->estado ? 'fa-toggle-on' : 'fa-toggle-off' }}"></i>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="font-semibold capitalize">{{ $nivelesAlerta[$palabra->nivel_alerta] }}</span>
                                        </div>
                                        <div class="flex justify-between">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="font-semibold capitalize">{{ $palabra->especialidad_recomendada }}</span>
                                        </div>
                ...
                <form id="formPalabra">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="peso_urgencia" name="peso_urgencia" step="0.1" min="0.1"
                                max="1.0"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <select id="especialidad_id" name="especialidad_id"
                                ...
                                @foreach ($especialidades as $rol => $grupo)
                                    <optgroup label="{{ ucfirst($rol) }}">
                                        @foreach ($grupo as $especialidad)
