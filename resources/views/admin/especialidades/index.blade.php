...
<body class="bg-gray-100 min-h-screen">
        ...
        <div class="bg-white rounded-2xl shadow p-8 mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Administra las especialidades disponibles para cada tipo de profesional</p>
                </div>
                        ...
                        <div class="border rounded-lg p-4 hover:shadow-md transition duration-200"
                            ...
                            <div class="flex justify-between items-start mb-3">
                                <div class="flex items-center">
                                    <i class="{{ $especialidad->icono }} mr-2" style="color: {{ $especialidad->color }};"></i>
                                ...
                                <div class="flex space-x-1">
                                    ...
                                    <button onclick="eliminarEspecialidad({{ $especialidad->id_especialidad }})"
    ...
    <div id="modalEspecialidad" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
